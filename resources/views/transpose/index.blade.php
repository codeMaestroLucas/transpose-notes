...
@section('content')
    <div x-data="transposeApp()" x-init="init()">
        ...
        <div class="d-flex justify-content-end gap-2 mb-3 no-print">
            {{-- PDF button --}}
            <button class="btn btn-outline-secondary btn-sm btn-pdf bg-white" @click="downloadPdf()"
                :disabled="notes.do.length === 0 || isDownloading" title="Baixar PDF">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="tone-card tone-card--do h-100">
                    <div class="tone-header tone-header--do text-center">
                        <textarea class="song-title-input" placeholder="Nome do Louvor" x-model="songTitle" rows="1"
                            @input="autoResizeTitle($event)" @keydown.tab.prevent="startEditing()" x-init="$nextTick(() => autoResizeTitle({ target: $el }))"></textarea>
                    ...
                    <div class="do-editable-area" @click="startEditing()">
                        ...
                        <div x-show="isEditing" class="editing-wrapper" x-transition>
                            <textarea x-ref="notesTextarea" class="notes-input-inline" x-model="inputText" @input="onInput()" @blur="stopEditing()"></textarea>
                        ...
                        <div x-show="!isEditing" class="notes-display" x-transition>
                            ...
                            <span x-show="notes.do.length === 0 && !inputText" class="text-muted"
        ...
        <div class="toast-container position-fixed bottom-0 end-0 p-3">
            <div id="download-toast" class="toast align-items-center text-bg-dark border-0" role="alert"
